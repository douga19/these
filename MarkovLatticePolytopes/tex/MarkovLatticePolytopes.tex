...
\affil[1]{LIPN, Université Paris 13, Villetaneuse, France}
\date{}
\maketitle
...
%We chose to measure two quantities on our lattice polygons in order to get estimations of the mixing time via the ergodic theory: the number of vertices and the area.
%We measured these quantities on walks with respectively 1000, 10000, and 100000 steps for $3\leq{k}<100$. Then we compare the average measures for the two latter quantities in different length walks in Figure~\ref{Fig.NV}\footnote{we provide more detailed results in Table~\ref{Tab.Summary} in Appendix~\ref{Sec.Tab}.}.
